...
void TripAuthenticatedRequestHandler::append_bootstrap_scripts(std::ostream& os) const
{
  ...
  os <<
    "    <script type=\"module\" src=\"./static/bootstrap-5.2.0-dist/js/bootstrap.min.js\"></script>\n";
}
...
void TripAuthenticatedRequestHandler::append_body_start(std::ostream& os) const
{
  ...
  os <<
    ...
    "            -->\n"
    "            <li class=\"nav-item\"><a class=\"nav-link\" href=\"https://www.fdsd.co.uk/trip-web-client-docs/\" target=\"_blank\">" <<
